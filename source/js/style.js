...
function runtime(){
    ...
    var item = document.getElementById("spantime");
    item.innerHTML = A+"天"+B+"时"+C+"分"+D+"秒"
...
function setbackground(){    
    var image = new Image();
    image.src = "https://i0.hdslb.com/bfs/album/3f7bb9b1d309dd645651ef9f5be79e5faedd44be.webp";

    image.onload = function() {
        var item = document.getElementsByClassName("page-container")[0];
